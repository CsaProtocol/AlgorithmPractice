...
void zMyLinearInt(unsigned int& testnum, unsigned int& testerr) {
    ...
    vecDup.Sort();
    Traverse(testnum, testerr, vecDup, true, &TraversePrint<int>); // Expected: 1,2,2,3,4
    ...
    vecDup.Map([](int& i) { i = i * i; });
    Traverse(testnum, testerr, vecDup, true, &TraversePrint<int>); // All elements 0
    ...
    Traverse(testnum, testerr, vecDup, true, &TraversePrint<int>); // 1,4,9,16,25
    ...
    Empty(testnum, testerr, vecExist, true);
...
void zMyLinearDouble(unsigned int& testnum, unsigned int& testerr) {
    ...
    lasd::SortableVector<double> vec2(5);
    vec1 = vec2;
    Empty(testnum, testerr, vec1, false);
    EqualVector(testnum, testerr, vec1, vec2, true);
    ...
    Traverse(testnum, testerr, vec4, true, &TraversePrint<double>);
    pos = 0;
    FoldPreOrder(testnum, testerr, vec4, true, [&pos](const double& i, const double& a) { return pos++ % 2 ? a - i : a + i; }, 0.0, -5.0);
    pos = 0;
    FoldPostOrder(testnum, testerr, vec4, true, [&pos](const double& i, const double& a) { return pos++ % 2 ? a - i : a + i; }, 0.0, 5.0);
    ...
    lasd::List<double> lst3(lst2);
    lasd::SortableVector<double> vec9(std::move(lst2));
